...
n_layers = 3
outputdir = 'outputs_landslide_nh_small_scale'
...
options.fields_to_export = ['uv_2d', 'elev_2d', 'elev_ls', 'bathymetry_3d']
#options.horizontal_viscosity = Constant(0.04)
...
solver_obj.assign_initial_conditions(uv_2d=Constant((1E-13, 0.)))
